  ...
  <main class="mt-3" id="homepage-margin">
    <div class="container" style="max-width: 1400px; position: relative; left: 150px;">
      ...
      <c:if test="${user.grade == 'pro' }">
	      <button type="button" class="btn btn-outline-success st-write" onclick="location.href='<c:url value="/store/productIn" />'">상품등록</button>
      </c:if>
      <div class="row">
                 ...
                 <div class="col-xl-3 col-lg-4 col-md-6">
                   <div class="card" style="width: 18rem;">
                     ...
                     <div class="card-body">
                       ...
                       <p class="card-text">
                         <span class="badge bg-default" >${product.category1 }</span>
                         <span class="badge bg-default" >${product.category2 }</span>
                       </p>
